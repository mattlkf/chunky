...
/*       fs::path(absl::GetFlag(FLAGS_store)), // Location of chunkserver
 * storage */
/*       absl::GetFlag(FLAGS_chunk_size_bytes) // Chunk size in bytes */
/*   ); */

/*   // Load the chunkserver state from disk */
...
/*   vector<char> hello_vec(hello_str.begin(), hello_str.end()); */
/*   chunkserver.setData("test_chunk", 5, "client_a", {0, 11}, hello_vec); */
...
/*   // [Testing] Overwrite chunk file */
/*   chunkserver.setChunkVersionNumber("test_chunk", 6); */
/*   string gfs_str = "GFS"; */
/*   string ver_str = "2.0"; */
/*   vector<char> gfs_vec(gfs_str.begin(), gfs_str.end()); */
/*   vector<char> ver_vec(ver_str.begin(), ver_str.end()); */
/*   chunkserver.setData("test_chunk", 6, "client_b", {9, 3}, ver_vec); */
/*   chunkserver.setData("test_chunk", 6, "client_b", {6, 3}, gfs_vec); */
/*   chunkserver.requestWrite("test_chunk", 6, "client_b"); */

/*   // [Testing] Read a chunk file */
/*   auto ret2 = chunkserver.getChunkData("test_chunk", 6, {0, 12}); */
/*   auto v2 = ret2.ValueOrDie(); */
